...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC1_LM (13312 * SZ_1K) // 13MiB, will work for all roms
...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC1 (11264 * SZ_1K) // 11MiB, may not work for all roms (probably will though)
