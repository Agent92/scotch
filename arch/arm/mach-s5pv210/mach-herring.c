...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC1_LM (9216 * SZ_1K) // 9MiB, may not work for all roms (will for CM though)
...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC1 (9216 * SZ_1K) // 9MiB, may not work for all roms (will for CM though)
