...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC0_LM (11264 * SZ_1K)
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC1_LM (11264 * SZ_1K) // 9MiB, may not work for all roms (will for CM though)
...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC1 (11264 * SZ_1K) // 9MiB, may not work for all roms (will for CM though)
=======
...
>>>>>>> 06e6153... Revert user conifgurable memory (doesn't work quite yet)
